...
(function($) {
    $(function() {
        ...
        $('body').on('mouseover', '.mega-menu a.list-item.inactive', function(e) {
            ...
            //     $(".mega-menu .overlay-panel").animate({
            //         opacity: "0.15"
            //     }, 0);
            //     $(_this).addClass('active').removeClass('inactive');
            //     $(_this).siblings().addClass('inactive').removeClass('active');
        ...
        $( "#menu-item-2" ).mouseover(function() {
            $("#menu-item-2 > a").css("background-color","#d92727");
        });

        $( "#menu-item-2" ).mouseleave(function() {
            $("#menu-item-2 > a").css("background-color","");
        });


        $( "#menu-item-3" ).mouseover(function() {
            $("#menu-item-3 > a").css("background-color","#fc8f12");
        });

        $( "#menu-item-3" ).mouseleave(function() {
            $("#menu-item-3 > a").css("background-color","");
        });

        $( "#menu-item-4" ).mouseover(function() {
            $("#menu-item-4 > a").css("background-color","#0db8b5");
        });

        $( "#menu-item-4" ).mouseleave(function() {
            $("#menu-item-4 > a").css("background-color","");
        });

        $( "#menu-item-5" ).mouseover(function() {
            $("#menu-item-5 > a").css("background-color","#6fcc43");
        });

        $( "#menu-item-5" ).mouseleave(function() {
            $("#menu-item-5 > a").css("background-color","");
        });
        ...
        $('body').on('click', '.sortbar .sort-metrics a', function(e) {
            ...
            // container.find(".loop").animate({
            //     opacity: "1"
            // }, 0);
            // container.find(".sortbar .label-text").not(".static").animate({
            //     opacity: "1"
            // }, 0);
            // $.post(itAjax.ajaxurl, {
            //     action: 'itajax-sort',
            ...
            //         opacity: "1"
            //     }, 500);
            //     container.find(".sortbar .label-text").animate({
            //         opacity: "1"
            //     }, 500);
        ...
        $('.rating-wrapper .rateit').bind('rated reset', function(e) {
            ...
            if (noupdate == 1) {
                ...
                $.post(itAjax.ajaxurl, {
                    ...
                    $('.ratings .total .user_rating > div').stop().delay(200).fadeOut(200).delay(500).queue(function(n) {
        ...
        $('body').on('click', '.reaction.clickable', function(e) {
            ...
            var _this = this;
            $('.reaction-percentage').stop().animate({
                opacity: "1"
            }, 100);
